        ...
        <section class="lg:flex lg:min-h-screen lg:pt-16">
            <div class="bg-[#EBF3F5] z-10 flex justify-center items-start flex-col gap-2 lg:gap-4 w-full px-10 pt-24 lg:pt-10 pb-10 lg:px-20">
                <div class="flex gap-1">
                    ...
                    <p class="text-[#5C8692] text-xs">WELCOME TO <span class="font-manropeBold">WEDDING WONDERS!!!</span></p>
                </div>
                <div class="w-full">
                    <h1 class="font-playfairDisplayBold text-3xl">Undangan Impianmu Kini Hanya dengan Sekali Klik</h1>
                </div>
