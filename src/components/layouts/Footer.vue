        ...
        <div class="flex flex-col items-start justify-between gap-5 p-10 w-full lg:w-[70%] lg:gap-10">
            <div class="flex flex-col items-start gap-3 lg:flex-row justify-between w-full">
                <div class="flex gap-3">
                    ...
                    <h2 class=" font-playfairDisplayBold text-xl lg:text-2xl">Wedding Wonders</h2>
                </div>
                <ul class="flex gap-1">
                    <li class="flex justify-center w-8 h-8 lg:w-10 lg:h-10 items-center border-2 border-[#5C8692]">
                        <svg class="w-2 lg:w-3" viewBox="0 0 10 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="flex justify-center w-8 h-8 lg:w-10 lg:h-10 items-center border-2 border-[#5C8692]">
                        <svg class="w-3 lg:w-4" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="flex justify-center w-8 h-8 lg:w-10 lg:h-10 items-center border-2 border-[#5C8692]">
                        <svg class="w-3 lg:w-4" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.125 14V4.65625H0.21875V14H3.125ZM1.65625 3.40625C2.59375 3.40625 3.34375 2.625 3.34375 1.6875C3.34375 0.78125 2.59375 0.03125 1.65625 0.03125C0.75 0.03125 0 0.78125 0 1.6875C0 2.625 0.75 3.40625 1.65625 3.40625ZM13.9688 14H14V8.875C14 6.375 13.4375 4.4375 10.5 4.4375C9.09375 4.4375 8.15625 5.21875 7.75 5.9375H7.71875V4.65625H4.9375V14H7.84375V9.375C7.84375 8.15625 8.0625 7 9.5625 7C11.0625 7 11.0938 8.375 11.0938 9.46875V14H13.9688Z" fill="#ffffff"/>
                        </svg>
                    </li>
                </ul>
            </div>
            <div class="flex flex-col lg:flex-row gap-3 items-start text-sm lg:text-base w-full justify-start lg:gap-24">
                <ul class="flex flex-col lg:gap-2">
                    <li class="text-lg lg:text-xl font-playfairDisplayBold">Menu</li>
                ...
                <ul class="flex flex-col lg:gap-2">
                    <li class="text-lg lg:text-xl font-playfairDisplayBold">Media Sosial</li>
                    <li><a href="">Facebook</a></li>
                    <li><a href="">Twitter</a></li>
                    <li><a href="">LinkedIn</a></li>
                </ul>
                <div class="flex flex-col lg:gap-2 items-start">
                    <h3 class="text-lg lg:text-xl font-playfairDisplayBold">Hubungi Kami</h3>
                    <table>
                        <tbody>
                            <tr class=" align-top">
                                <td>Alamat</td>
                                <td>: 24A Kingston St, Los Vegas NC 28202, USA.</td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>: wedding.wonders@gmail.com</td>
                            </tr>
                            <tr>
                                <td>Telepon</td>
                                <td>: (+62) 123 - 4567 - 900</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
